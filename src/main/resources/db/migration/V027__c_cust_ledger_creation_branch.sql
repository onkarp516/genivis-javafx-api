...
DROP PROCEDURE if EXISTS create_counter_customer_ledger_branch;
DELIMITER &&
CREATE PROCEDURE create_counter_customer_ledger_branch(IN outlet_id BIGINT,IN branch_id BIGINT,IN created_by BIGINT)
BEGIN
   ...
   `pincode`, `email`, `mobile`, `taxable`, `gstin`, `state_code`, `registration_type`, `date_of_registration`, `pancard`, `bank_name`,
    ...
    `balancing_method_id`, `associates_groups_id`) VALUES
     ('Counter Customer', 'CNCS', 'SUDR', 'Counter_Customer_Branch', 'Dr', 0, 'Solapur', 413005, 'c@gmail.com', 9879879879, b'0', 'NA',
     '27', 3, NULL, NULL, 'NA', 'NA', 'NA', 'NA', 'NA', 'sundry_debtors', created_by, '2022-10-10 16:54:11',
     NULL, '2022-10-10 16:54:11', b'1', 'PG#1', b'0', b'1', b'0', 0, 'NA', 'NA', NULL, NULL, NULL, NULL, NULL, 3, 1, 1, branch_id, outlet_id, 101, 4008, 2, NULL);
END &&
DELIMITER ;
