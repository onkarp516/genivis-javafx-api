...
ALTER TABLE tranx_journal_details_tbl ADD CONSTRAINT FK_TRANX_JOURNAL_DETAILS_TBL_ON_TRANX_JOURNAL_MASTER FOREIGN KEY (tranx_journal_master_id) REFERENCES tranx_journal_master_tbl (id);
