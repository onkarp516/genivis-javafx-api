...
ALTER TABLE tranx_pur_return_invoice_tbl ADD CONSTRAINT FK_TRANX_PUR_RETURN_INVOICE_TBL_ON_ADDITIONAL_LEDGER_ID1 FOREIGN KEY (additional_ledger_id1) REFERENCES ledger_master_tbl (id);

ALTER TABLE tranx_pur_return_invoice_tbl ADD CONSTRAINT FK_TRANX_PUR_RETURN_INVOICE_TBL_ON_ADDITIONAL_LEDGER_ID2 FOREIGN KEY (additional_ledger_id2) REFERENCES ledger_master_tbl (id);

ALTER TABLE tranx_pur_return_invoice_tbl ADD CONSTRAINT FK_TRANX_PUR_RETURN_INVOICE_TBL_ON_ADDITIONAL_LEDGER_ID3 FOREIGN KEY (additional_ledger_id3) REFERENCES ledger_master_tbl (id);
...
ALTER TABLE tranx_purchase_return_details_units_tbl ADD CONSTRAINT FK_TRANX_PURCHASE_RETURN_DETAILS_UNITS_TBL_ON_BATCH FOREIGN KEY (batch_id) REFERENCES product_batchno_tbl (id);

ALTER TABLE tranx_purchase_return_details_units_tbl ADD CONSTRAINT FK_TRANX_PURCHASE_RETURN_DETAILS_UNITS_TBL_ON_BRAND FOREIGN KEY (brand_id) REFERENCES brand_tbl (id);

ALTER TABLE tranx_purchase_return_details_units_tbl ADD CONSTRAINT FK_TRANX_PURCHASE_RETURN_DETAILS_UNITS_TBL_ON_CATEGORY FOREIGN KEY (category_id) REFERENCES category_tbl (id);

ALTER TABLE tranx_purchase_return_details_units_tbl ADD CONSTRAINT FK_TRANX_PURCHASE_RETURN_DETAILS_UNITS_TBL_ON_FLAVOUR_MASTER FOREIGN KEY (flavour_master_id) REFERENCES flavour_master_tbl (id);

ALTER TABLE tranx_purchase_return_details_units_tbl ADD CONSTRAINT FK_TRANX_PURCHASE_RETURN_DETAILS_UNITS_TBL_ON_GROUP FOREIGN KEY (group_id) REFERENCES group_tbl (id);

ALTER TABLE tranx_purchase_return_details_units_tbl ADD CONSTRAINT FK_TRANX_PURCHASE_RETURN_DETAILS_UNITS_TBL_ON_LEVEL_A FOREIGN KEY (level_a_id) REFERENCES level_a_tbl (id);

ALTER TABLE tranx_purchase_return_details_units_tbl ADD CONSTRAINT FK_TRANX_PURCHASE_RETURN_DETAILS_UNITS_TBL_ON_LEVEL_B FOREIGN KEY (level_b_id) REFERENCES level_b_tbl (id);

ALTER TABLE tranx_purchase_return_details_units_tbl ADD CONSTRAINT FK_TRANX_PURCHASE_RETURN_DETAILS_UNITS_TBL_ON_LEVEL_C FOREIGN KEY (level_c_id) REFERENCES level_c_tbl (id);

ALTER TABLE tranx_purchase_return_details_units_tbl ADD CONSTRAINT FK_TRANX_PURCHASE_RETURN_DETAILS_UNITS_TBL_ON_PACKAGING FOREIGN KEY (packaging_id) REFERENCES packing_master_tbl (id);
...
ALTER TABLE tranx_purchase_return_details_units_tbl ADD CONSTRAINT FK_TRANX_PURCHASE_RETURN_DETAILS_UNITS_TBL_ON_SUBCATEGORY FOREIGN KEY (subcategory_id) REFERENCES sub_category_tbl (id);
...
CREATE TABLE tranx_pur_return_invoice_product_sr_no_tbl (
  id BIGINT AUTO_INCREMENT NOT NULL,
   ...
   level_b_id BIGINT NULL,
   level_c_id BIGINT NULL,
   pur_return_unit_details_id BIGINT NULL,
   units_id BIGINT NULL,
   CONSTRAINT pk_tranx_pur_return_invoice_product_sr_no_tbl PRIMARY KEY (id)
);

ALTER TABLE tranx_pur_return_invoice_product_sr_no_tbl ADD CONSTRAINT FK_TRANXPURRETURNINVOICEPRODUCTSRNOTBL_ON_PURRETURNUNITDETAILS FOREIGN KEY (pur_return_unit_details_id) REFERENCES tranx_purchase_return_details_units_tbl (id);
...
ALTER TABLE tranx_pur_return_invoice_product_sr_no_tbl ADD CONSTRAINT FK_TRANX_PUR_RETURN_INVOICE_PRODUCT_SR_NO_TBL_ON_LEVEL_A FOREIGN KEY (level_a_id) REFERENCES level_a_tbl (id);

ALTER TABLE tranx_pur_return_invoice_product_sr_no_tbl ADD CONSTRAINT FK_TRANX_PUR_RETURN_INVOICE_PRODUCT_SR_NO_TBL_ON_LEVEL_B FOREIGN KEY (level_b_id) REFERENCES level_b_tbl (id);

ALTER TABLE tranx_pur_return_invoice_product_sr_no_tbl ADD CONSTRAINT FK_TRANX_PUR_RETURN_INVOICE_PRODUCT_SR_NO_TBL_ON_LEVEL_C FOREIGN KEY (level_c_id) REFERENCES level_c_tbl (id);
...
ALTER TABLE tranx_pur_return_invoice_product_sr_no_tbl ADD CONSTRAINT FK_TRANX_PUR_RETURN_INVOICE_PRODUCT_SR_NO_TBL_ON_UNITS FOREIGN KEY (units_id) REFERENCES units_tbl (id);
