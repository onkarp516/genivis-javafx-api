...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tranx_sales_quotation_duties_taxes_tbl")
public class TranxSalesQuotationDutiesTaxes {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long id;

    @ManyToOne
    @JoinColumn(name = "sales_quotation_invoice_id", nullable = false)
    @JsonManagedReference
    private TranxSalesQuotation salesQuotationTransaction;
