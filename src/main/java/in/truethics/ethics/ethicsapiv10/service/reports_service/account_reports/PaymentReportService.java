...
public class PaymentReportService {
    ...
    public static final Logger stockLogger = LogManager.getLogger(PurRegisterReportService.class);
...
//            LocalDate endDate = LocalDate.parse(request.getParameter("end_date"));
    ...
    public InputStream exportToExcelPaymentmonth(Map<String, String> jsonRequest, HttpServletRequest request) throws IOException {
        Users users = jwtRequestFilter.getUserDataFromToken(request.getHeader("Authorization").substring(7));
        try {
...
//                        System.out.println("data ------> " + s);
    ...
    public InputStream exportToExcelPayment(Map<String, String> jsonRequest, HttpServletRequest request) throws IOException {
        Users users = jwtRequestFilter.getUserDataFromToken(request.getHeader("Authorization").substring(7));
        try {
//            Boolean mfgShow = Boolean.valueOf(request.getParameter("mfgShow"));
            String JsonToStr = jsonRequest.get("list");
