...
public interface TranxSalesInvoicePrSrNoRepository extends
        JpaRepository<TranxSalesInvoiceProductSrNumber,Long> {

    TranxSalesInvoiceProductSrNumber findByIdAndStatus(Long detailsId, boolean b);
    @Query(value = "select id,serial_no from tranx_sales_invoice_product_sr_no_tbl where product_id=?1 " +
